# MDE View – powershell.exe

## 1. Expected Surfacing

Depending on configuration, powershell.exe abuse may surface as:
...
- Is powershell.exe ever legitimately used on this workstation/server?
