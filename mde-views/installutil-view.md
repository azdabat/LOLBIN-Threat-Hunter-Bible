# MDE View – installutil.exe

## 1. Expected Surfacing

Depending on configuration, installutil.exe abuse may surface as:
...
- Is installutil.exe ever legitimately used on this workstation/server?
